...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.ra.blog.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.ra.blog.security.DomainUserDetailsService", "createSpringSecurityUser");
